 ...
 *
 * 实现 restful 示例 
 * GET      /api/restfulExample/users                              列出所有用户
 * GET      /api/restfulExample/users/1                            获取指定用户的信息
 * POST     /api/restfulExample/users/?name=SAT&count=23           新建一个用户
 * PUT      /api/restfulExample/users/1?name=SAT&count=23          更新指定用户的信息（全部信息）
 * PATCH    /api/restfulExample/users/1?name=SAT                   更新指定用户的信息（部分信息）
 * DELETE   /api/restfulExample/users/1                            删除指定用户
 *
 */
